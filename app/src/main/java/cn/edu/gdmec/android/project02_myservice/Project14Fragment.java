        ...
        mThread4 = new Thread(){
            ...
            public void run() {
                ...
                while (true){
                    ...
                    res1 = HttpUtils.send("http://192.168.1.183:8080/TrafficServer/action/SetRoadLightStatusAction.do",json);
                    parseJson();
        ...
        mThread1 = new Thread(){
            ...
            public void run() {
                ...
                while (true){
                    ...
                    res1 = HttpUtils.send("http://192.168.1.183:8080/TrafficServer/action/GetSenseByName.do",json);
                    parseJson();
